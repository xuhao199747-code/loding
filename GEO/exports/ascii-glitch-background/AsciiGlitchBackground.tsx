...
import "./ascii-glitch-background.css"
import asciiBackground from "./ascii-background.txt?raw"
...
export function AsciiGlitchBackground({ className = "" }: AsciiGlitchBackgroundProps) {
  ...
  return (
    <div className={`ascii-glitch-background ${className}`} aria-hidden="true">
      <div className="ascii-glitch-background__scanlines" />
      <pre className="ascii-glitch-background__text">{frame}</pre>
      <div className="ascii-glitch-background__noise" />
    </div>
  )
}
