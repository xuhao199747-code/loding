...
const AI_PRESETS = [
    { name: '思考中', layout: 'grid', pattern: 'wave', easing: 'sineInOut', speed: 0.6, color: '#FA5A0A', shape: 'rect', cols: 3, rows: 3, gap: 8, cornerRadius: 30 },
    ...
    { name: '呼吸灯', layout: 'grid', pattern: 'breathe', easing: 'sine', speed: 0.5, color: '#FA5A0A', shape: 'circle', cols: 1, rows: 1, gap: 0, cornerRadius: 0 },
    ...
    { name: '神经网络', layout: 'network', pattern: 'wave', easing: 'sineInOut', speed: 1.0, color: '#FF8C42', particleCount: 25, connectionDist: 100 },
    { name: '星座连线', layout: 'network', pattern: 'breathe', easing: 'sine', speed: 0.6, color: '#94a3b8', particleCount: 15, connectionDist: 120 },
    { name: '棋盘翻转', layout: 'grid', pattern: 'checkerboard', easing: 'back', speed: 1.5, color: '#FF8C42', shape: 'square', cols: 6, rows: 6, gap: 4 },
