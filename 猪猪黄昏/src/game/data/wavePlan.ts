...
export const wavePlan: WaveDefinition[] = [
  ...
  { index: 2, spawnBudget: 18, spawnIntervalMs: 1350, enemies: ["fatPig", "leanPig", "forkPig"] },
  { index: 3, spawnBudget: 22, spawnIntervalMs: 1250, enemies: ["fatPig", "leanPig", "helmetPig"] },
  { index: 4, spawnBudget: 26, spawnIntervalMs: 1200, enemies: ["fatPig", "forkPig", "chargePig"] },
  { index: 5, spawnBudget: 30, spawnIntervalMs: 1100, enemies: ["leanPig", "chargePig", "feedPig"] },
  { index: 6, spawnBudget: 34, spawnIntervalMs: 1000, enemies: ["helmetPig", "forkPig", "elitePenPig"] },
  { index: 7, spawnBudget: 38, spawnIntervalMs: 925, enemies: ["chargePig", "feedPig", "elitePenPig"] },
  { index: 8, spawnBudget: 42, spawnIntervalMs: 850, enemies: ["helmetPig", "chargePig", "elitePenPig"] },
  { index: 9, spawnBudget: 46, spawnIntervalMs: 800, enemies: ["forkPig", "feedPig", "elitePenPig"] },
  { index: 10, spawnBudget: 0, spawnIntervalMs: 0, enemies: ["helmetPig", "chargePig", "elitePenPig"], bossId: "pigKing" }
];
